        ...
        >
            ...
            <div class="relative min-h-full flex justify-center items-end sm:items-center p-0 sm:p-4">
                <div
                    x-dialog:panel
                    x-transition.in
                    class="relative max-w-[80vw] w-full bg-white dark:bg-gray-900 dark:text-white rounded-t-xl sm:rounded-b-xl shadow-lg overflow-hidden"
                >
                    ...
                    <div class="absolute top-0 right-0 pt-4 pr-4">
                        <button type="button" x-on:click="$dialog.close()" class="bg-gray-50 dark:bg-gray-800 rounded-lg p-2 text-gray-600 focus:outline-none focus-visible:ring-2 focus-visible:ring-blue-500 focus-visible:ring-offset-2">
                    ...
                    <div class="p-8">
                        ...
                        @isset($footerActions)
                        <div class="p-4 py-4 px-4 -mx-8 -mb-8 mt-8 border-t border-grey-500/50">
