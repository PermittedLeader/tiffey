...
<div 
    class="flex flex-col bg-white dark:bg-gray-500 dark:bg-opacity-25 {{ config('tiffey.rounded') }} border-solid {{ config('tiffey.card-border') }} {{ $inModal ? '' : 'mt-2 shadow-xl dark:shadow-none mb-4 mx-1 md:mx-0' }} divide-y divide-inherit"
