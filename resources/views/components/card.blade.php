...
<div 
    class="flex flex-col {{ config('tiffey.card-bg-color') }} {{ config('tiffey.card-text-color') }} {{ config('tiffey.rounded') }} border-solid {{ config('tiffey.card-border') }} {{ $inModal ? '' : 'mt-2 shadow-xl dark:shadow-none mb-4 mx-1 md:mx-0' }} divide-y divide-inherit {{ $attributes['class'] }}"
